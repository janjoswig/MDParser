...
class TestTopologyTasks:
    def test_get_subsections(self, tasks_top):
        ...
        assert isinstance(subsections[0].value, mdtop.DEFAULT_NODE_VALUE_TYPES["atoms"])

        assert isinstance(subsections[1].value, mdtop.DEFAULT_NODE_VALUE_TYPES["bonds"])
    ...
    def test_get_last_entry(self, tasks_top):
        ...
        assert isinstance(
            last_entry.value, mdtop.DEFAULT_NODE_VALUE_TYPES["atoms_entry"]
        )
